...
@section('content')
                ...
                <div class="modal-body">
                    <form id="emailForm" action="#" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="from" name="from" placeholder="De"
                                           disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="to" name="to" placeholder="Para"
                                           disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea style="resize: none;" class="form-control" name="message" rows="8"
                                              maxlength="250" id="message"></textarea>
                                    <label for="message" class="control-label">Mensagem</label>
                                    <p id="length" class="show-length">
                                        <small>0/250</small>
                                    </p>
                                </div>
                            </div>
    ...
    <table class="table-hover container-fluid table-docente table-striped visible-sm visible-md visible-lg">
        ...
        <tr>
            ...
            <td class="col-sm-2">
                <button type="button" onClick="sendEmailTo('ariane@gmail.com')" class="btn btn-success btn-block"><span
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-collapse collapse" id="1">
                <div class="panel-body">
                    ...
                    <button type="button" onClick="sendEmailTo('ariane@gmail.com')"
                            class="btn btn-success btn-block btn-mobile">Contatar
                    </button>
                    </td>
                </div>
            </div>

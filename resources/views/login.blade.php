        ...
        <div class="main">
            <div class="well">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p class="text-main">Bem vindo ao NSAC do Colégio Técnico Industrial "Prof. Isaac Portal
                            Roldán"</p>
                    </div>
                    <div class="col-md-4"></div>
                </div>
                                ...
                                <div class="feature-card center-block">
                                    <div class="container-fluid">
                                        ...
                                        <p class="feature-text">
                                            <small>Acompanhe a página do Facebook da escola para ficar ligado nas
                                                novidades
                                            </small>
                                        </p>
                                    </div>
                            ...
                            <a class="feature-link" href="http://www.cti.feb.unesp.br/" target="_blank">
                                <div class="feature-card center-block">
                                    <div class="container-fluid">
                                        ...
                                        <p class="feature-text">
                                            <small>Acesse o site da escola para obter mais informações sobre eventos,
                                                etc...
                                            </small>
                                        </p>
                                    </div>
                            ...
                            <a class="feature-link" href="https://pt-br.facebook.com/cti.unesp.bauru/" target="_blank">
                                <div class="feature-card center-block">
                                    <div class="container-fluid">
                                        ...
                                        <h4 class="feature-title">Facebook</h4>
                                        <p class="feature-text">
                                            <small>Acesse a página do Facebook do grupo Adde para ter mais informações
                                                do grupo
                                            </small>
                                        </p>
                                    </div>
